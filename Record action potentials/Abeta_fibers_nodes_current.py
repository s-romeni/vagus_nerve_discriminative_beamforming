...
for d in range(6,13):
    ...
    ##-------------------------------------------------------------------------
    scipy.io.savemat('Abeta_fiber_' + str(diameter) + '.mat', {'data': data, 'area': area, 'num_node': fiber.n_ranvier, 'dt': h.dt, 'diameter': diameter, 'x': fiber.x})
